...
status.register("disk",
        path="/nas/Filme",
        format="NAS:used>{used}G avail>{avail}G",)
status.register("disk",
        path="/mnt/daten",
        format="DATA:used>{used}G avail>{avail}G",)
status.register("disk",
        path="/mnt/daten2",
        format="DATA2:used>{used}G avail>{avail}G",)
status.register("disk",
        path="/",
...
#status.register("pyload",
#        address="https://pyload.peter-johennecken.de",
#        username="pit",
#        password="",)
